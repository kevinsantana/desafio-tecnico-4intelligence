...
from cadastro_usuarios.resources import v1
from cadastro_usuarios.files import description_html
from cadastro_usuarios.resources.v1 import doc_sphinx
from cadastro_usuarios.exceptions import UserRegistrationException
...
description = open(description_html).read()
...
async def camara_exception_handler(request: Request, exception: UserRegistrationException):
    return JSONResponse(
